        ...
        <div className='bg-black text-white py-20'id='about'>
            <div className='cantainer mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    ...
                    className='w-70 h-70 rounded-cover mb-8 md:mb-0'/>
                    <div className='flex-1'>
                    <p className='text-lg mb-8'>
                        I am a passionate full-stack developer with a 
                        focus on building modern ans responsive web 
                        applications. With a strong foundation in both
                         frontend ans backend technologies, I strive a
                          create seamless and efficient user experience.
                    </p>
