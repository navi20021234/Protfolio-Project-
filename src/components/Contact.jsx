...
const Contact = () => {
        ...
        <div className='bg-black text-white py-20'id='contact'>
                    <div className='cantainer mx-auto px-8 md:px-16 lg:px-24'>
                        ...
                        <h3 className='text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Let's Talk</h3> 
                            ...
                            <p>I'm open to discussing web development projects or partnersgip opportunities.</p>
                            <div className='mb-4 '>
    ...
    <form className='space-y-6 p-6 bg-gray-900 rounded-lg'>
        ...
        <div className='text-center md:text-left'>
            <button className='bg-gradient-to-r from-green-400 to-blue-500 text-white transform transition-transform duration-300 hover:scale-105 px-6 py-3 rounded-full'>
                Send
            </button>
        </div>
    </form>
